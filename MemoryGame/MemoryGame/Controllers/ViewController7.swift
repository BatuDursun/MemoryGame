...
//  MemoryGame
//
//  Created by Batu Dursun on 10.12.2023.
//
...
class ViewController7: UIViewController {
    ...
    @IBOutlet var skorLabel:UILabel!
    @IBOutlet var imageView:UIImageView!
    
    @IBOutlet var timerLabel:UILabel!
    
    @IBOutlet var toplamSureLabel:UILabel!
    ...
    override func viewDidLoad() {
        ...
        // Tüm butonlara atanan imageleri 4 saniye boyunca gösterir.
    ...
    @IBAction func exitButtonTapped(_ sender: UIButton) {
        ...
        // Yukarıdaki satır, uygulamayı arka planda askıya alır ve sonlandırma işlemini tetikler.
    }
    ...
    func compare() {
        if images[click1-1] == images[click2-1] {
            ...
            DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 1) {
                ...
                self.skorLabel.text = "SKOR/HAMLE: \(self.points1) /  \(self.points2)"
            }
        } else {
            //different images
            DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 1) {
    ...
    func levelUp() {
        if  self.points1 == 12 {
            ...
            myTimer.invalidate()
            toplamSure.shared.sure1 = toplamSure.shared.sure1 + counter - 16
            
            toplamSureLabel.text = "Toplam Süre: \(String(toplamSure.shared.sure1))sn"
    ...
    @objc func timerRun() {
    counter += 1
    timerLabel.text = "Süre: \(String(counter - 4))sn" }
